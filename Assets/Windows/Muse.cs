...
namespace Interaxon.Libmuse
{
    ...
    public class Muse
    {
        ...
        private MusePreset preset = MusePreset.PRESET_21;
        ...
        public void EnableLedIndicator(bool enable)
        {
            Native.EnableLedIndicator(BluetoothMac, enable);
        }
        ...
        public void SetLicenseData(byte[] dataBlob)
        {
            Native.SetLicenseData(BluetoothMac, dataBlob);
        }

        public void SetProperty(string name, string value)
        {
            Native.SetProperty(BluetoothMac, name, value);
        }
    }
}
